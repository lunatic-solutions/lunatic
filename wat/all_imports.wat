...
(module
    ...
    (import "lunatic::message" "send_skip_search_receive" (func (param i64)))
    (import "lunatic::message" "receive" (func (param i64) (result i32)))

    (import "lunatic::networking" "resolve" (func (param i32 i32 i32) (result i32)))
    ...
    (import "lunatic::networking" "tcp_connect" (func (param i32 i32 i32 i32 i32 i32) (result i32)))
