...
(module
    ...
    (import "lunatic::networking" "set_read_timeout" (func (param i64 i64) (result i32)))
    (import "lunatic::networking" "get_read_timeout" (func (param i64) (result i64)))
    (import "lunatic::networking" "set_write_timeout" (func (param i64 i64) (result i32)))
    (import "lunatic::networking" "get_write_timeout" (func (param i64) (result i64)))
    (import "lunatic::networking" "set_peek_timeout" (func (param i64 i64) (result i32)))
