...
(module
    ...
    (import "lunatic::sqlite" "query_result_get" (func (param i64 i32 i32)))
    (import "lunatic::sqlite" "drop_query_result" (func (param i64)))
    ...
    (import "lunatic::sqlite" "last_error" (func (param i64) (result i64)))
    (import "lunatic::sqlite" "read_column" (func (param i64 i32) (result i64)))
    (import "lunatic::sqlite" "read_row" (func (param i64) (result i64)))
