...
(module
    ...
    (import "lunatic::metrics" "span_start" (func (param i64 i32 i32 i32 i32) (result i64)))
    (import "lunatic::metrics" "span_drop" (func (param i64)))
    (import "lunatic::metrics" "meter" (func (param i32 i32) (result i64)))
    (import "lunatic::metrics" "meter_drop" (func (param i64)))
    (import "lunatic::metrics" "event" (func (param i64 i32 i32 i32 i32)))
    (import "lunatic::metrics" "counter" (func (param i64 i32 i32 i32 i32 i32 i32) (result i64)))
    (import "lunatic::metrics" "counter_add" (func (param i64 i64 f64 i32 i32)))
    (import "lunatic::metrics" "counter_drop" (func (param i64)))
    (import "lunatic::metrics" "up_down_counter" (func (param i64 i32 i32 i32 i32 i32 i32) (result i64)))
    (import "lunatic::metrics" "up_down_counter_add" (func (param i64 i64 f64 i32 i32)))
    (import "lunatic::metrics" "up_down_counter_drop" (func (param i64)))
    (import "lunatic::metrics" "histogram" (func (param i64 i32 i32 i32 i32 i32 i32) (result i64)))
    (import "lunatic::metrics" "histogram_record" (func (param i64 i64 f64 i32 i32)))
    (import "lunatic::metrics" "histogram_drop" (func (param i64)))
