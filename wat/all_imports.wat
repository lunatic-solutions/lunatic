...
(module
    ...
    (import "lunatic::message" "receive" (func (param i32) (result i64)))
    ;; TODO is_signal, drop_message
    (import "lunatic::message" "read_data" (func (param i64 i32 i32) (result i32)))
    (import "lunatic::message" "process_id" (func (param i64 i32)))
    (import "lunatic::message" "seek_data" (func (param i64 i64)))
    (import "lunatic::message" "get_reply_handle" (func (param i64) (result i64)))
    (import "lunatic::message" "drop_reply_handle" (func (param i64)))
    (import "lunatic::message" "data_size" (func (param i64) (result i64)))
    (import "lunatic::message" "take_process" (func (param i64 i64) (result i64)))
    (import "lunatic::message" "take_tcp_stream" (func (param i64 i64) (result i64)))
