...
(module
    ...
    (import "lunatic::message" "send" (func (param i64 i64)))
    (import "lunatic::message" "send_receive_skip_search" (func (param i64 i64 i32) (result i32)))
    ...
    (import "lunatic::process" "spawn" (func (param i64 i64 i64 i64 i32 i32 i32 i32 i32) (result i32)))
    ...
    (import "lunatic::process" "node_id" (func (result i64)))
    (import "lunatic::process" "link" (func (param i64 i64 i64)))
    (import "lunatic::process" "unlink" (func (param i64 i64)))
